...
public class AllJudgeService : MonoBehaviour
{
    ...
    public void Judge(float currentTime)
    {
        ...
        List<ReilasNoteEntityToGameObject>[] tapNotes =
            _gamePresenter.alreadyChangeKujo && RhythmGamePresenter.jumpToKujo
                ? RhythmGamePresenter.TapKujoNoteLanes
                : RhythmGamePresenter.TapNoteLanes;

        if (tapNotes == RhythmGamePresenter.TapNoteLanes) Debug.Log("nomal");
        else Debug.Log("gimmick");
        ...
        if (_gamePresenter.alreadyChangeKujo && RhythmGamePresenter.jumpToKujo) internalNotes = RhythmGamePresenter.InternalKujoNotes;
        ...
        if (_gamePresenter.alreadyChangeKujo && RhythmGamePresenter.jumpToKujo) chainNotes = RhythmGamePresenter.ChainKujoNotes;
