...
namespace Rhythmium
{
    ...
    /// </remarks>
    public abstract class ChartConverter<TChartEntity, TNoteEntity, TNoteLineEntity>
        where TChartEntity : ChartEntity<TNoteEntity, TNoteLineEntity>
        ...
        where TNoteLineEntity : NoteLineEntity<TNoteEntity>
    {
        ...
        protected TChartEntity Convert(ChartJsonData chartJsonData, TChartEntity chart)
        {
            ...
            chart.Difficulty = (ChartDifficulty)(chartJsonData.difficulty + 1);
